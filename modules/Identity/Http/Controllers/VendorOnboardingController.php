...
use ModulesShoppingComplex\Identity\Http\Requests\SaveOnboardingRequest;
use ModulesShoppingComplex\Identity\Http\Requests\SubmitOnboardingRequest;
...
class VendorOnboardingController extends Controller
{
    ...
    public function onboarding(): Response|RedirectResponse
    {
        ...
        $onboarding = $this->onboardingService->getOnboarding($user->id);
    ...
    public function saveOnboarding(SaveOnboardingRequest $request): RedirectResponse|JsonResponse
    {
        ...
        $this->onboardingService->saveOnboardingDraft(
            $user,
