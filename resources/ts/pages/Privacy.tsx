        ...
        <>
            ...
            <div className="min-h-screen bg-brand-surface font-display">
                ...
                <div className="max-w-3xl mx-auto px-4 py-12">
                    <h1 className="text-3xl font-bold text-brand-ink mb-2">Privacy Policy</h1>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 space-y-8 text-gray-700 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">1. Introduction</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">2. Information We Collect</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">3. How We Use Your Information</h2>
                            <ul className="list-disc pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">4. WhatsApp Data</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">5. Data Sharing</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">6. Data Retention</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">7. Your Rights</h2>
                            <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@jiidaa.com" className="text-brand-green hover:underline">hello@jiidaa.com</a>.</p>
                        </section>

                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">8. Security</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-semibold text-brand-ink mb-3">9. Contact</h2>
