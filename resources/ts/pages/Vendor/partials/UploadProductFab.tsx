        ...
        <>
            {!isEditMode && !hideFab && (
                <button
                    ...
                    className="fixed bottom-24 right-5 w-14 h-14 bg-brand-green text-white rounded-full shadow-lg hover:bg-brand-ink hover:shadow-xl transition-all flex items-center justify-center z-50 group"
                >
