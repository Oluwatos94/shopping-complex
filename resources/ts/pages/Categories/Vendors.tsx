            ...
            <main className="flex-1">
                ...
                <section className="bg-gradient-to-br from-brand-ink to-brand-green-dark text-white py-14 lg:py-20">
                    <div className="container mx-auto px-4">
                        <Link href="/categories" className="inline-flex items-center text-white/70 hover:text-white transition-colors mb-4 text-sm">
                    ...
                    <div className="container mx-auto px-4">
                        {vendors.data.length === 0 ? (
                            <div className="text-center py-16">
                                ...
                                <p className="text-gray-600 text-lg mb-6">No vendors in this category yet.</p>
                                <Link href="/categories" className="bg-brand-green text-white px-6 py-3 rounded-lg font-semibold hover:bg-brand-ink transition-colors">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                                {vendors.data.map((vendor) => (
                                    ...
                                    >
                                        ...
                                        <div className="h-44 bg-gray-100 overflow-hidden">
                                            {vendor.profileImage ? (
                                                ...
                                                <div className="w-full h-full flex items-center justify-center bg-brand-green/10">
                                                    <span className="text-5xl font-bold text-brand-green/40">
                                        ...
                                        <div className="p-4">
                                            <h3 className="font-bold text-brand-ink text-lg mb-2 group-hover:text-brand-green transition-colors">
                                                {vendor.name}
                                            </h3>
                                                ...
                                                <div className="space-y-1">
                                                    {vendor.products.map((product) => (
                                                        <div key={product.id} className="flex justify-between text-sm">
                                                            ...
                                                            <span className="text-brand-green font-medium ml-2 flex-shrink-0">
                                            ...
                                            <div className="mt-3 pt-3 border-t border-gray-100 flex items-center justify-between">
                                                <span className="text-xs text-gray-600">View store</span>
