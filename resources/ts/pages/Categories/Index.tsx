            ...
            <main className="flex-1">
                ...
                <section className="py-16 lg:py-20">
                    <div className="container mx-auto px-4">
                        {categories.length === 0 ? (
                            <p className="text-center text-gray-600 text-lg">No categories available yet.</p>
                        ) : (
                                        ...
                                        <div className="relative h-64 overflow-hidden">
                                            {categoryImages[category.id] ? (
                                                ...
                                                <div className="w-full h-full bg-brand-green/10 flex items-center justify-center">
                                                    <svg className="w-16 h-16 text-brand-green/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
