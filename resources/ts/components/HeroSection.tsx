                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 w-full items-center">
                    ...
                    <div>
                        ...
                        <p className="text-lg text-primary-brown leading-relaxed mb-8 max-w-lg">
                            Discover local vendors in real-time through our platform or directly on
                            WhatsApp. Instant connections to what you need.
                        </p>
                        ...
                        <div className="flex flex-row gap-3 mb-8">
                            <Link
                                href="/products"
                                className="flex-1 inline-flex items-center justify-center bg-primary-dark text-white px-4 py-3.5 sm:px-6 sm:py-4 rounded-xl text-sm sm:text-base font-semibold hover:bg-primary-brown transition-colors duration-200 shadow-lg shadow-primary-dark/20"
                            >
                                Start Shopping
                            </Link>
                            ...
                            <a
                                ...
                                className="flex-1 inline-flex items-center justify-center border border-primary-dark text-primary-dark hover:bg-primary-dark hover:text-white px-4 py-3.5 sm:px-6 sm:py-4 rounded-xl text-sm sm:text-base font-semibold transition-colors duration-200"
                            >
                            ...
                            <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                                ...
                                <div className="bg-[#f0f2f5] px-3 py-3 flex items-center gap-2 border-t border-gray-100">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="w-10 h-10 rounded-full bg-primary-dark hover:bg-primary-brown transition-colors flex items-center justify-center flex-shrink-0 shadow-md"
