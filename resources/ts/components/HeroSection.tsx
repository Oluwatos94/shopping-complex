                    ...
                    <div>
                        ...
                        <div className="flex flex-row gap-3 mb-8">
                            ...
                            <a
                                ...
                                className="flex-1 inline-flex items-center justify-center bg-[#25D366] hover:bg-[#1ebe5d] text-white px-4 py-3.5 sm:px-6 sm:py-4 rounded-xl text-sm sm:text-base font-semibold transition-colors duration-200 shadow-lg shadow-[#25D366]/25"
                            >
